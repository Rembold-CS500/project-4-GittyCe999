...
print_simple_or_variant_checks((r"prints\User1_Original.txt"), (r"prints\User1_Variant1.txt"))

#    Use for checking shifted variants
def print_shifted_check(file1, file2):
    print(shifted_check(file1, file2, "M", 3, 140, 5))

print_shifted_check((r"prints\User2_Original.txt"), (r"prints\User2_ShiftedVariant2.txt"))
